/* @ts-self-types="./match3dice_wasm.d.ts" */
...
export class GameEngine {
    ...
    finish_move() {
        wasm.gameengine_finish_move(this.__wbg_ptr);
    }
    /**
     * @returns {any}
     */
    ...
    init_level() {
        wasm.gameengine_init_level(this.__wbg_ptr);
    }
    /**
     * @returns {GameEngine}
     */
    ...
    restart() {
        wasm.gameengine_restart(this.__wbg_ptr);
    }
    /**
    ...
    start_move(direction) {
        ...
        const ret = wasm.gameengine_start_move(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    toggle_shift() {
        wasm.gameengine_toggle_shift(this.__wbg_ptr);
    }
    use_bomb() {
        wasm.gameengine_use_bomb(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('match3dice_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
